    ...
    <main class="admin-main">
        ...
        <section style="margin-top:22px">
            ...
            <div class="card" style="padding:16px;margin-bottom:18px;">
                <h3 style="margin:0 0 12px 0"><?php echo (int)$editing['id'] > 0 ? 'Sửa tin tuyển dụng' : 'Đăng tin tuyển dụng'; ?></h3>
                <form method="post" style="display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;">
                    ...
                    <div>
                        <label class="small">Địa điểm</label>
                        <input class="form-control" type="text" name="location" value="<?php echo h($editing['location']); ?>">
                    </div>
                    <div>
                        <label class="small">Mức lương</label>
                        <input class="form-control" type="text" name="salary" value="<?php echo h($editing['salary']); ?>">
                    </div>
                    <div>
                        <label class="small">Hạn nộp</label>
                    ...
                    <div>
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option value="0" <?php echo (int)$editing['status'] === 0 ? 'selected' : ''; ?>>Đóng</option>
                        </select>
                    </div>

                    <div style="grid-column:1 / -1;">
                        <label class="small">Mô tả</label>
                        <textarea class="form-control" name="description" rows="4"><?php echo h($editing['description']); ?></textarea>
                    </div>

                    <div style="grid-column:1 / -1;display:flex;gap:10px;">
                        <button class="btn-admin" type="submit"><?php echo (int)$editing['id'] > 0 ? 'Cập nhật' : 'Đăng tin'; ?></button>
                        <?php if ((int)$editing['id'] > 0): ?>
                            <a class="btn-admin" href="<?php echo h($adminRoutes['recruitments']); ?>" style="text-decoration:none;display:inline-flex;align-items:center;">Hủy</a>
                        <?php endif; ?>
                    </div>
                </form>
            </div>
